            ...
            <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                <form class="space-y-6" action="/sessions" method="POST">
                    <div>
                        ...
                        <div class="mt-2">
                            <input type="email" name="email" id="email" autocomplete="email"  class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
                        </div>
                        <p class="text-color-red"><?= isset($errors["email"]) ? $errors["email"] : "" ?></p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="text-color-red"><?= isset($errors["password"]) ? $errors["password"] : "" ?></p>
