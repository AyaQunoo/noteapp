            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="/about" class=" <?= isUrl('/about.php') ? "bg-gray-900 " : "text-gray-300 hover:bg-gray-700" ?>rounded-md px-3 py-2 text-sm font-medium text-gray-300  hover:text-white">About us</a>
                        <a href="/notes" class=" <?= isUrl('/about.php') ? "bg-gray-900 " : "text-gray-300 hover:bg-gray-700" ?>rounded-md px-3 py-2 text-sm font-medium text-gray-300  hover:text-white">Notes</a>
                       
                        <a href="/contact" class=" <?= isUrl('/contact.php') ? "bg-gray-900 " : "text-gray-300 hover:bg-gray-700" ?>rounded-md px-3 py-2 text-sm font-medium text-gray-300  hover:text-white">Contact</a>
                    </div>
                </div>
            </div>
            <div class="hidden md:block">
